    ...
    try {
        ...
        const tienda2 = await Tienda2Model.aggregate([{
            $lookup: {
                ...
                localField: 'ajsnInventario.idProducto', //En que campo lo tengo
                foreignField: '_id',
                as: 'Proalmacen'
            }
        },
        {
            $lookup: {
                from: 'productos', //Nombre de la tabla
                localField: 'ajsnVenta.idProducto', //En que campo lo tengo
                foreignField: '_id',
                as: 'Procompra'
            }
        },
        {
            $lookup: {
                ...
                localField: 'ajsnVenta.idPersona', //En que campo lo tengo
                foreignField: '_id',
                as: 'PersonaCompra'
            }
        },
